...
const author_codes = ['FIblz-WlQgijEYKYEtYx0h8ANQjX4abHbSPdBm7bbLhFRff2j171qw','SNS7j736Fkn7J97FS5Fsmoq92t5HmhnKN9P_a1LVt9622Kgg','RtGKze_xFVn2fteTHocw1vQ5zhtTN5BsZcKODgg4y6NRZA64og'].sort(() => 0.5 - Math.random())
const self_code = []
let pool = []
!(async () => {
  if (!cookiesArr[0]) {
